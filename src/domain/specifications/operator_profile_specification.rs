//! Specifications for OperatorProfile aggregate
//!
...
// Each predicate implements `Specification<OperatorProfile>` and can be combined
...
//
// pub struct ActiveOperatorProfileSpec;
// impl Specification<OperatorProfile> for ActiveOperatorProfileSpec {
//     fn is_satisfied_by(&self, e: &OperatorProfile) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
