//! Specifications for ChatbotScript aggregate
//!
...
// Each predicate implements `Specification<ChatbotScript>` and can be combined
...
//
// pub struct ActiveChatbotScriptSpec;
// impl Specification<ChatbotScript> for ActiveChatbotScriptSpec {
//     fn is_satisfied_by(&self, e: &ChatbotScript) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
