//! Specifications for ChatbotStep aggregate
//!
...
// Each predicate implements `Specification<ChatbotStep>` and can be combined
...
//
// pub struct ActiveChatbotStepSpec;
// impl Specification<ChatbotStep> for ActiveChatbotStepSpec {
//     fn is_satisfied_by(&self, e: &ChatbotStep) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
