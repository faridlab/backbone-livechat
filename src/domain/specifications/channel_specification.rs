//! Specifications for Channel aggregate
//!
...
// Each predicate implements `Specification<Channel>` and can be combined
...
//
// pub struct ActiveChannelSpec;
// impl Specification<Channel> for ActiveChannelSpec {
//     fn is_satisfied_by(&self, e: &Channel) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
