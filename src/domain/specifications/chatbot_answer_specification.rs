//! Specifications for ChatbotAnswer aggregate
//!
...
// Each predicate implements `Specification<ChatbotAnswer>` and can be combined
...
//
// pub struct ActiveChatbotAnswerSpec;
// impl Specification<ChatbotAnswer> for ActiveChatbotAnswerSpec {
//     fn is_satisfied_by(&self, e: &ChatbotAnswer) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
