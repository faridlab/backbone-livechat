//! Specifications for ChannelRule aggregate
//!
...
// Each predicate implements `Specification<ChannelRule>` and can be combined
...
//
// pub struct ActiveChannelRuleSpec;
// impl Specification<ChannelRule> for ActiveChannelRuleSpec {
//     fn is_satisfied_by(&self, e: &ChannelRule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
