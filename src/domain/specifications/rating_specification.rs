//! Specifications for Rating aggregate
//!
...
// Each predicate implements `Specification<Rating>` and can be combined
...
//
// pub struct ActiveRatingSpec;
// impl Specification<Rating> for ActiveRatingSpec {
//     fn is_satisfied_by(&self, e: &Rating) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
