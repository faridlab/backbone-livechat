//! Specifications for ChannelMember aggregate
//!
...
// Each predicate implements `Specification<ChannelMember>` and can be combined
...
//
// pub struct ActiveChannelMemberSpec;
// impl Specification<ChannelMember> for ActiveChannelMemberSpec {
//     fn is_satisfied_by(&self, e: &ChannelMember) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
