//! Specifications for LivechatAuditLog aggregate
//!
...
// Each predicate implements `Specification<LivechatAuditLog>` and can be combined
...
//
// pub struct ActiveLivechatAuditLogSpec;
// impl Specification<LivechatAuditLog> for ActiveLivechatAuditLogSpec {
//     fn is_satisfied_by(&self, e: &LivechatAuditLog) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
