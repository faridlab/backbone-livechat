//! Specifications for ExpertiseTag aggregate
//!
...
// Each predicate implements `Specification<ExpertiseTag>` and can be combined
...
//
// pub struct ActiveExpertiseTagSpec;
// impl Specification<ExpertiseTag> for ActiveExpertiseTagSpec {
//     fn is_satisfied_by(&self, e: &ExpertiseTag) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
