//! Specifications for ChatbotMessage aggregate
//!
...
// Each predicate implements `Specification<ChatbotMessage>` and can be combined
...
//
// pub struct ActiveChatbotMessageSpec;
// impl Specification<ChatbotMessage> for ActiveChatbotMessageSpec {
//     fn is_satisfied_by(&self, e: &ChatbotMessage) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
