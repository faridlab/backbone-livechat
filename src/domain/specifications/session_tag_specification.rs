//! Specifications for SessionTag aggregate
//!
...
// Each predicate implements `Specification<SessionTag>` and can be combined
...
//
// pub struct ActiveSessionTagSpec;
// impl Specification<SessionTag> for ActiveSessionTagSpec {
//     fn is_satisfied_by(&self, e: &SessionTag) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
