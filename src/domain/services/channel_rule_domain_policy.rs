//! Domain policy for ChannelRule aggregate
//!
...
/// Domain policy for ChannelRule — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ChannelRule>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ChannelRuleDomainPolicy = PermitAllPolicy<ChannelRule>;
