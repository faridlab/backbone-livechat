//! Domain policy for ChatbotAnswer aggregate
//!
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ChatbotAnswer>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ChatbotAnswerDomainPolicy = PermitAllPolicy<ChatbotAnswer>;
