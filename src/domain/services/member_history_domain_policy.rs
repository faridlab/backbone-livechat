//! Domain policy for MemberHistory aggregate
//!
...
/// Domain policy for MemberHistory — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MemberHistory>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MemberHistoryDomainPolicy = PermitAllPolicy<MemberHistory>;
