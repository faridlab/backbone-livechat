//! Domain policy for ExpertiseTag aggregate
//!
...
/// Domain policy for ExpertiseTag — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ExpertiseTag>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ExpertiseTagDomainPolicy = PermitAllPolicy<ExpertiseTag>;
