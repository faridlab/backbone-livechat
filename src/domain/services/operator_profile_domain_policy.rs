//! Domain policy for OperatorProfile aggregate
//!
...
/// Domain policy for OperatorProfile — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OperatorProfile>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OperatorProfileDomainPolicy = PermitAllPolicy<OperatorProfile>;
