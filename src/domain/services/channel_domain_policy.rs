//! Domain policy for Channel aggregate
//!
...
/// Domain policy for Channel — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Channel>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ChannelDomainPolicy = PermitAllPolicy<Channel>;
