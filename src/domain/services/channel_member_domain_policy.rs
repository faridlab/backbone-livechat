//! Domain policy for ChannelMember aggregate
//!
...
/// Domain policy for ChannelMember — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ChannelMember>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ChannelMemberDomainPolicy = PermitAllPolicy<ChannelMember>;
