//! Domain policy for SessionTag aggregate
//!
...
/// Domain policy for SessionTag — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SessionTag>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SessionTagDomainPolicy = PermitAllPolicy<SessionTag>;
