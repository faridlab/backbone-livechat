//! ChannelMember DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ChannelMember
///
...
/// Request DTO for full update of a ChannelMember
///
...
/// Request DTO for partial update of a ChannelMember
///
...
/// Response DTO for ChannelMember entity
///
...
/// Paginated list response for ChannelMember entities
///
...
pub struct ChannelMemberListResponseDto {
    /// List of items
    pub items: Vec<ChannelMemberResponseDto>,
...
impl ChannelMemberListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<ChannelMemberResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ChannelMemberSummaryDto {
    pub id: Uuid,
    pub channel_id: Uuid,
    pub user_id: Uuid,
...
impl From<ChannelMember> for ChannelMemberResponseDto {
    fn from(entity: ChannelMember) -> Self {
        Self {
            id: entity.id,
...
impl From<ChannelMember> for ChannelMemberSummaryDto {
    fn from(entity: ChannelMember) -> Self {
...
impl From<CreateChannelMemberDto> for ChannelMember {
    fn from(dto: CreateChannelMemberDto) -> Self {
        Self {
            id: Uuid::new_v4(),
...
impl backbone_core::FromCreateDto<CreateChannelMemberDto> for ChannelMember {
    fn from_create_dto(dto: CreateChannelMemberDto) -> backbone_core::ServiceResult<Self> {
        Ok(ChannelMember::from(dto))
    }
}

impl backbone_core::ApplyUpdateDto<UpdateChannelMemberDto> for ChannelMember {
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to ChannelMember here.
