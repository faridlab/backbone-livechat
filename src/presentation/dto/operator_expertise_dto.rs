//! OperatorExpertise DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new OperatorExpertise
///
...
/// Request DTO for full update of a OperatorExpertise
///
...
/// Request DTO for partial update of a OperatorExpertise
///
...
/// Response DTO for OperatorExpertise entity
///
...
/// Paginated list response for OperatorExpertise entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct OperatorExpertiseListResponseDto {
    /// List of items
    pub items: Vec<OperatorExpertiseResponseDto>,
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct OperatorExpertiseSummaryDto {
    pub id: Uuid,
    pub operator_profile_id: Uuid,
    pub expertise_tag_id: Uuid,
    pub company_id: Uuid,
...
impl From<OperatorExpertise> for OperatorExpertiseResponseDto {
    fn from(entity: OperatorExpertise) -> Self {
        Self {
            id: entity.id,
...
impl From<OperatorExpertise> for OperatorExpertiseSummaryDto {
    fn from(entity: OperatorExpertise) -> Self {
...
impl From<CreateOperatorExpertiseDto> for OperatorExpertise {
    fn from(dto: CreateOperatorExpertiseDto) -> Self {
        Self {
            id: Uuid::new_v4(),
...
impl backbone_core::FromCreateDto<CreateOperatorExpertiseDto> for OperatorExpertise {
    fn from_create_dto(dto: CreateOperatorExpertiseDto) -> backbone_core::ServiceResult<Self> {
        Ok(OperatorExpertise::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to OperatorExpertise here.
