//! LivechatAuditLog REST handlers
//!
...
pub enum LivechatAuditLogError {
    #[error("Not found: {0}")]
    NotFound(String),
...
impl From<ServiceError> for LivechatAuditLogError {
...
impl axum::response::IntoResponse for LivechatAuditLogError {
...
/// Create Axum router with all 16 Backbone endpoints for LivechatAuditLog.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /livechat_audit_logs | List with pagination |
/// | POST | /livechat_audit_logs | Create new |
/// | GET | /livechat_audit_logs/:id | Get by ID |
/// | PUT | /livechat_audit_logs/:id | Full update |
/// | PATCH | /livechat_audit_logs/:id | Partial update |
/// | DELETE | /livechat_audit_logs/:id | Soft delete |
/// | POST | /livechat_audit_logs/bulk | Bulk create |
/// | POST | /livechat_audit_logs/upsert | Upsert |
/// | GET | /livechat_audit_logs/trash | List deleted |
/// | POST | /livechat_audit_logs/:id/restore | Restore |
/// | DELETE | /livechat_audit_logs/empty | Empty trash |
/// | GET | /livechat_audit_logs/:id/deleted | Get deleted by ID |
/// | DELETE | /livechat_audit_logs/trash/:id | Permanent delete from trash |
/// | GET | /livechat_audit_logs/count | Count active entities |
/// | GET | /livechat_audit_logs/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
/// let service = Arc::new(LivechatAuditLogService::with_repository(repository));
...
#[cfg(feature = "auth")]
pub fn create_protected_livechat_audit_log_routes<A: AuthMiddleware + Send + Sync + 'static>(
    service: Arc<LivechatAuditLogService>,
    auth: Arc<A>,
) -> Router {
    use axum::middleware;
