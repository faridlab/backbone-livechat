...
impl From<ServiceError> for MemberHistoryError {
...
impl axum::response::IntoResponse for MemberHistoryError {
...
/// Create Axum router with all 16 Backbone endpoints for MemberHistory.
///
/// # Routes
///
/// | Method | Path | Description |
/// |--------|------|-------------|
/// | GET | /member_histories | List with pagination |
/// | POST | /member_histories | Create new |
/// | GET | /member_histories/:id | Get by ID |
/// | PUT | /member_histories/:id | Full update |
/// | PATCH | /member_histories/:id | Partial update |
/// | DELETE | /member_histories/:id | Soft delete |
/// | POST | /member_histories/bulk | Bulk create |
/// | POST | /member_histories/upsert | Upsert |
/// | GET | /member_histories/trash | List deleted |
/// | POST | /member_histories/:id/restore | Restore |
/// | DELETE | /member_histories/empty | Empty trash |
/// | GET | /member_histories/:id/deleted | Get deleted by ID |
/// | DELETE | /member_histories/trash/:id | Permanent delete from trash |
/// | GET | /member_histories/count | Count active entities |
/// | GET | /member_histories/trash/count | Count deleted entities |
///
/// # Example
///
/// ```text
/// let service = Arc::new(MemberHistoryService::with_repository(repository));
...
#[cfg(feature = "auth")]
pub fn create_protected_member_history_routes<A: AuthMiddleware + Send + Sync + 'static>(
    service: Arc<MemberHistoryService>,
    auth: Arc<A>,
) -> Router {
    use axum::middleware;
